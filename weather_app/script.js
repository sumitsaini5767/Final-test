...
const API = "2ab14451e34009bc2a5b5e8aa0ec768e";
...
function rightSideContent(result) {
  // Convert sunset and sunrise to 24 hour time format
  ...
  return `<div class="content">
        ...
        <div class="content">
          ...
          <span class="value" id="visibility">${result.visibility}m</span>
        </div>
        <div class="content">
          <p class="title">SUNRISE</p>
          <span class="value" id="sunset">${sunriseTime}</span>
        </div>
        <div class="content">
          <p class="title">SUNSET</p>
          <span class="value" id="sunrise">${sunsetTime}</span>
        </div>`;
}
